...
# # Model preparation 
PATH_TO_FROZEN_GRAPH = 'part_6/frozen_inference_graph.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = 'part_6/labelmap.pbtxt'
NUM_CLASSES = 1
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    while True:
      ...
      image_np = np.array(cv2.imread("CSGO_images/train/1.jpg"))
      ...
      cv2.imshow("",cv2.cvtColor(image_np, cv2.COLOR_BGR2RGB))
